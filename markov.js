...
class MarkovMachine {
  ...
  makeChains() {
    ...
    // Build the word chain for all the words in this.words.

    const outChain = {};
    if (this.words.length > 1) {
      // prime prev with first word and add the first word to outChain.
      //  (a reduce might be possible -- processing an entire array and producing
      //   an output that was influenced by all values in the source array).
      ...
      // at this point, prev word is the last word. push null
